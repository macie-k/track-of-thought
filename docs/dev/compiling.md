...
- JDK
    - Up
      to [Version 10](https://www.oracle.com/java/technologies/java-archive-javase10-downloads.html) -
      contains JavaFX
    - Or [Newer](https://www.oracle.com/java/technologies/javase-downloads.html) - requires
      separate [JavaFX](https://openjfx.io/) download
